...
public class TestLogFileHandler {
    ...
    byte[] testUnescaped = new byte[]{0xFF, 0xFF, -27, 0xFF, 0xFF, 0xFF, -128, 0xFF, 0xFF};
    byte[] expectedEscaped = new byte[]{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, -27, 0xFF, 0xFF, 0xFF, 0xFF, -128, 0xFF, 0xFF, 0xFF};
